                            ...
                            <div class="sidebar clearfix m-b-20">
                                ...
                                <div class="main-block">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control search-field" placeholder="Search your favorite Product" name="searchdata" id="searchdata"> <span class="input-group-btn"> 
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <label class="custom-control custom-checkbox">
                                                    <span class="custom-control-description"><a href="viewprod-companywise.php?editid=<?php echo $row['CompanyName'];?>"><?php echo $row['CompanyName'];?></a></span> </label>
                                            </li>
