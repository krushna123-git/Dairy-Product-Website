...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <section class="hero bg-image" data-image-src="images/fast-food-e21500cbfa.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Find your Product!</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="post" name="search" action="search-prod.php">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">would u like to order....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount"  name="searchdata" id="searchdata" placeholder="would u like to order...."> </div>
                            </div>
                            <button onclick="location.href='search-prod.php'" type="submit" name="search" class="btn theme-btn btn-lg">Search product</button>
                        </form>
                    </div>
                    <div class="steps">
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>Popular Dairy Products Here: <span class="primary-color">All over India</span> </span>
            </div>
        </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">The easiest way to get your dairy product</p>
                </div>
...
?>
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                <h5><a href="prod-detail.php?fid=<?php echo $row['ID'];?>"><?php echo $row['ItemName'];?></a></h5>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with menus from over 345 dairy products online.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your Product delivered! And enjoy your day! Pay Cash on delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
