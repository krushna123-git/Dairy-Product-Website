                        ...
                        <div class="sidebar clearfix m-b-20">
                            <div class="main-block">
                                <div class="sidebar-title white-txt">
                                    <h6>Product Companies</h6> <i class="fa fa-cutlery pull-right"></i> </div>
                                    <?php
                               ...
                               <ul>
                                            ...
                                            <li>
                                                <label class="custom-control custom-checkbox">
                                                    <span class="custom-control-description"><a href="viewprod-companywise.php?catid=<?php echo $row['CompanyName'];?>"><?php echo $row['CompanyName'];?></a></span> </label>
                                            </li>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        <div class="menu-widget m-b-30">
                            <div class="widget-heading">
                              ...
                              Your Order  Dairy Product! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular" aria-expanded="true">
...
<h6><a href="prod-detail.php?fid=<?php echo $_SESSION['fid']=$row['FoodId'];?>"><?php echo $row['ItemName']?> (<?php echo $row['ItemQty']?>) </a></h6>
...
?>
 ...
 <a href="javascript:void(0);" onClick="popUpWindow('invoice.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Order Invoice" style="color:#fff">Invoice</a></p>
    ...
    <p style="color:green">
        <a href="javascript:void(0);" onClick="popUpWindow('cancelorder.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Cancel this order" style="color:green">Cancel this order </a>
    </p>
