...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <p><span class="primary-color"><strong>Find Your Product Here..</strong></span> </div>
            </p>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
                            <div class="sidebar clearfix m-b-20">
                                 <form name="search" method="post" action="search-prod.php">
                                <div class="main-block">
                                    <div class="sidebar-title white-txt">
                                        <h6>Search Product</h6> <i class="fa fa-cutlery pull-right"></i> </div>
                                    <div class="input-group">
                                        <input type="text" class="form-control search-field" placeholder="Search your Product" name="searchdata" id="searchdata"> <span class="input-group-btn"> 
