...
<form name="bwdatesreport"  action="bwdates-reports-details.php" method="post"> 
                ...
                <input type="radio" name="requesttype" value="">Not Confirmed Order
                  ...
                  <input type="radio" name="requesttype" value="Order Confirmed">Confirmed Order
                    <input type="radio" name="requesttype" value="Product being Prepared">Product Being Prepared Order
                      <input type="radio" name="requesttype" value="Product Pickup">Product Pickup Order
                      <input type="radio" name="requesttype" value="Product Delivered">Product Delivered order
                                        </div>
                                    </div>
