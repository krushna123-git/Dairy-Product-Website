...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update tblcategory set CompanyName ='$category' where ID=$eid");
    if ($query) {
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                ...
                                                <input id="categoryname" name="categoryname" type="text" class="form-control required" required="true" value="<?php  echo $row['CompanyName'];?>">
                                            </div>
                                            <?php } ?>
                                            <div class="form-group">
