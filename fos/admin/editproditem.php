...
if(isset($_POST['submit']))
  {
   ...
   $itempic=$_FILES["itemimages"]["name"];
    $query=mysqli_query($con, "update tblfood set CompanyName='$fcat',ItemName='$itemname',ItemPrice='$price',ItemDes='$description',ItemQty='$quantity' where ID='$cid'" );
    if ($query) {
...
?>
    ...
    echo $msg;
                                    ...
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Product Company:</label>
                                                <div class="col-sm-10"><input name='foodcategory' id="foodcategory" class="form-control white_bg" value="<?php  echo $row['CompanyName'];?>">
